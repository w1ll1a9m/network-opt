...
portfolio = pd.read_excel('Portfolio 11-10-19.xlsx', usecols = cols)
portfolio_head = pd.read_excel('Portfolio 11-10-19.xlsx')
...
#allmaterials = [5085977]527941
topmaterials = [5031906]

#tqdm(,, desc ='Processing materials', total = len(allmaterials))

#bar = pyprind.ProgBar(len(allmaterials), monitor=True, bar_char='█')

for mat in tqdm(topmaterials, desc ='Processing materials', total = len(topmaterials)):
    lastmat = mat
    #bar.update()
    #print(bar)
    d=[]
    ...
    if min_cost_flow.Solve() == min_cost_flow.OPTIMAL:
        ...
        #check this shit it is unfinished !!!!
